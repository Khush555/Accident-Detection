...
def send_notification(id,flag):
    ...
    if flag:
        notif = Notifications(notification="Accident took place",lattitude=80.9382,longitude=26.8698,accepted=0)
        
        notif.save()
    if id==1:
        pusher_client.trigger('my-channel', 'my-event', {'message2': 'Urgent\n please send ambulance as soon as possible at xyz address.'})
    if id==2:
        pusher_client.trigger('my-channel', 'my-event', {'request': 'Urgent Request to send an ambulance is made'})
    return
...
def sendmail():
    ...
    email_from = "wasnikkhush11@gmail.com"
    email_subject = "Urgent please send ambulance."
    email_body = "Accident happened at Latitude:26.8008689, Longitude:81.0214551 please send ambulance as soon as possible. Google map link :- https://www.google.com/maps/place/26%C2%B048'03.1%22N+81%C2%B001'17.2%22E/@26.8008737,81.0188802,17z/data=!3m1!4b1!4m4!3m3!8m2!3d26.8008689!4d81.0214551?entry=ttu "
...
class streaming(object):
    def __init__(self):
        ...
        self.model1=torch.hub.load('ultralytics/yolov5', 'custom', path='C:\\Users\\Abhishek Saini\\OneDrive\\Desktop\\Accident-Detection2\\AccidentDetectionSystem\\best (2).pt',device='cpu')
        self.model = torch.hub.load('ultralytics/yolov5', 'custom', path='C:\\Users\\Abhishek Saini\\OneDrive\\Desktop\\Accident-Detection2\\AccidentDetectionSystem\\accident2.pt',device='cpu')
